...
{
    console.log('EarthRadiusInMeters');
...
function GeocentricLatitude(lat) {
    console.log('GeocentricLatitude');
...
function NormalizeVectorDiff(b, a) {
    console.log('NormalizeVectorDiff');
...
function Calculate(oblate) {
    ...
    if (a != null) {
        ...
        if (b != null) {
            ...
            var distKm = Distance(ap, bp);
            $('div_Distance').innerHTML = distKm.toFixed(3) + '&nbsp;m';
